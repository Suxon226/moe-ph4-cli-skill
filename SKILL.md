---
name: moe-ph4-cli
description: Build, curate, and export MOE-based pharmacophore models from protein, peptide, ligand, or interface structures using moebatch, SVL, and mechanism-aware compression. Use when the task requires MOE pharmacophore generation, receptor-ligand or receptor-peptide pharmacophore curation, .ph4 query writing, or reproducible pharmacophore workflow automation.
---
...
4. `references/api_reference.md`
5. `references/svl_errors.md` when debugging MOE/SVL execution
